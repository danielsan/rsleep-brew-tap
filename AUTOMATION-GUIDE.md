    ...
    steps:
      ...
      - name: Update formula
        run: |
          ...
          # Pattern matches versions like v1.0.0, v1.2.3-alpha, v2.0.0-rc1, etc.
          sed -i "s|https://github.com/danielsan/rsleep/releases/download/v[0-9]\+[0-9.a-zA-Z-]*/rsleep-v[0-9]\+[0-9.a-zA-Z-]*-x86_64-apple-darwin.tar.gz|https://github.com/danielsan/rsleep/releases/download/${VERSION}/rsleep-${VERSION}-x86_64-apple-darwin.tar.gz|" rsleep.rb
          ...
          sed -i "s|https://github.com/danielsan/rsleep/releases/download/v[0-9]\+[0-9.a-zA-Z-]*/rsleep-v[0-9]\+[0-9.a-zA-Z-]*-aarch64-apple-darwin.tar.gz|https://github.com/danielsan/rsleep/releases/download/${VERSION}/rsleep-${VERSION}-aarch64-apple-darwin.tar.gz|" rsleep.rb
          ...
          sed -i "s|https://github.com/danielsan/rsleep/releases/download/v[0-9]\+[0-9.a-zA-Z-]*/rsleep-v[0-9]\+[0-9.a-zA-Z-]*-x86_64-unknown-linux-gnu.tar.gz|https://github.com/danielsan/rsleep/releases/download/${VERSION}/rsleep-${VERSION}-x86_64-unknown-linux-gnu.tar.gz|" rsleep.rb
